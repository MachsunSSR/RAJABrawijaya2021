		...
		<>
			...
			>
				...
				<ol type="1" className="list-decimal my-8 ml-5">
					<li>
						Rambut tidak boleh dicat, harus dipotong pendek dan rapi,
						tidak melebihi leher, telinga, maupun alis.
					</li>
					<li>
						Memakai kemeja putih lengan panjang, berkerah, berbahan kain
						(bukan kaos maupun jeans), rapi, tidak ketat dan tidak
						transparan.
					</li>
					<li>
						Memakai celana panjang berwarna hitam berbahan kain, tidak
						ketat, tidak bermotif dan tidak transparan.
					</li>
					...
					<li>
						...
						gelang, anting, kalung, cincin, jam tangan dan lain-lain.
					</li>
				</ol>
				<h1 className="my-8 text-black xs:text-xl sm:text-xl ex:text-3xl exl:text-3xl">
					B. Perempuan
				...
				<ol type="1" className="list-decimal my-8 ml-5">
					<li>
						...
						diperbolehkan mengenakan jepit rambut hanya berwarna hitam.
					</li>
					<li>
						Berjilbab: Jilbab berwarna putih segiempat simetris, tidak
						transparan, tidak bermotif, tidak berenda tanpa aksesoris
						tambahan kecuali jarum pentul/peniti, diperbolehkan memakai
						inner hijab/ciput dan menutup dada.
					</li>
					<li>
						Memakai kemeja lengan panjang berwarna putih polos berkerah
						berbahan kain (bukan berbahan kaos maupun jeans), rapi, tidak
						ketat, tidak bermotif dan tidak transparan.
					</li>
					<li>
						Memakai rok panjang wiru/rampel berwarna hitam polos berbahan
						kain (bukan berbahan kaos maupun chiffon), rapi, tidak ketat,
						tidak transparan, tidak bermotif, dan tanpa belahan.
					</li>
					<li>Memakai dasi berwarna hitam.</li>
					<li>Memakai ikat pinggang berwarna hitam polos.</li>
