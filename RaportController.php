...
class RaportController extends Controller
{
    ...
    public function action(Request $request) {
        try {
            ...
            session()->flash('raport_file', asset('rapor/pdf/2020/'.$raport->file));
    ...
    private function generateRaport2020($nim, $data) {
        ...
        $pdf = new Fpdf;
        $pdf->AddPage();
        $pdf->Image(base_path('rapor/2020.png'), 0, 0, 210);
        ...
        $pdf->SetXY(177, 148);
        $pdf->Write(0, $penugasan['superheroes']);
        $pdf->SetXY(177, 154);
        $pdf->Write(0, $penugasan['bussiness']);
        $pdf->SetXY(177, 160);
        $pdf->Write(0, $penugasan['adhikara_bercerita']);
        $pdf->SetXY(177, 166);
        $pdf->Write(0, $penugasan['motivation_letter']);
        $pdf->SetXY(177, 172);
        $pdf->Write(0, $penugasan['mental_health']);
        $pdf->SetXY(177, 178);
        $pdf->Write(0, $penugasan['video_kolaborasi']);
        ...
        $fileLocation = base_path('rapor/pdf/2020/');
