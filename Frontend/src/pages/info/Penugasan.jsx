    ...
    return (
        ...
        >
            ...
            <p className="my-8 text-lg">
                Halo mahasiswa baru Universitas Brawijaya, berikut adalah
                beberapa tugas yang harus kalian kerjakan agar bisa mengenali
                Universitas Brawijaya lebih baik lagi!
            </p>
            <h1 className="text-black xs:text-xl sm:text-xl ex:text-3xl exl:text-3xl">
                Penugasan Cluster
            </h1>
            <p className="my-8 text-lg">
                Dalam penugasan cluster ini, mahasiswa akan dibagi menjadi
                beberapa kelompok dimana kelompok tersebut dapat dilihat di RAJA
                Apps tanggal 13 Agustus 2021 pukul 14.00 WIB, tugas tersebut
                diantaranya:
            </p>
            ...
            <p className="my-8 text-lg">
                Seluruh penugasan dikumpulkan di RAJA Apps, jangan lupa baca
                panduan penugasan dengan baik, jangan malas membaca!
            </p>
            <p className="my-8 text-lg">
                Jangan panik, tetap tenang santui rileks enjoy!, semangat dan
                sehat selalu Brawijaya Muda!
            </p>
        </InfoTemplate>
    );
};
